...
public class Sequential1 extends MLPModel {
	...
	public Sequential1(int nbItems, int dim, String trainingfile, int batchsize, String modelfile, double lambda, double mu) throws IOException {
