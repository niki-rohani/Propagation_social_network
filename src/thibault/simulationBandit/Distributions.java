...
public class Distributions extends java.util.Random {
		...
		* The mean of this distribution is lambda.  The variance is lambda. */
		...
		/** Return the index i of the xi with proba pi of being true. */
		public synchronized int discrete(ArrayList<Double> prob) {
		 double u=nextUniform();
		 int indVal=0;
		...
		* Equivalent to nextChiSq(1) */
		...
		public static void main (String[] args)
		{
			 ...
			 Distributions r = new Distributions();
