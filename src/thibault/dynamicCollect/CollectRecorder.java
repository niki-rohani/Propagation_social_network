...
public class CollectRecorder {
	...
	//protected LinkedHashMap<CollectEvalMeasure,TreeMap<Long,Result>> measures;
	...
	public CollectRecorder(String modelName, Reward reward, int freqRecords,long maxNumberRecords){
		...
		//measures=CollectEvalMeasureListnew ArrayList<CollectEvalMeasure>(); //LinkedHashMap<CollectEvalMeasure,TreeMap<Long,Result>>(); 
	}
