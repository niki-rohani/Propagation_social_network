...
//TODO wrt Kernel kmeans,Spectral Clustering and Normalized Cuts

import similarities.StrSim;
import core.*;
import java.util.ArrayList;

public class WeightedKernelKMeans extends StrClustering {
	private int nb_it; // on relance nb_it fois 
	private int max_passes=500; // maximum de passages pour une iteration
	public WeightedKernelKMeans(int k){
		this(k,1);
	}
	public WeightedKernelKMeans(){
		this(5,1);
	}
	public WeightedKernelKMeans(int k,int nb_it){
		super(k);
		this.nb_it=nb_it;
	}
