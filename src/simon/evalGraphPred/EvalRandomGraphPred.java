...
public class EvalRandomGraphPred {

	String modelfil = "propagationModels/MLPProj_Dims-25_step-1_ratioInits-1.0_nbMaxInits--1_db-weibo_cascadesCol-cascades_1_start1_nbC30000/dP-true_tS-false_tR-false_tSC-false_diag-false_wDC-false_wDS-false_wDR-false_sim-5_unbiased-true_regul-1.0_multiSource-true/last";
	...
	public static void main(String args[]) {
		EvalRandomGraphPred e = new EvalRandomGraphPred() ;
		e.runOriented() ;
	}
